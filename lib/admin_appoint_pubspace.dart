...
class AdminAppointPubSpace extends StatefulWidget {
  @override
  _AdminAppointPubSpaceState createState() => _AdminAppointPubSpaceState();
}

class _AdminAppointPubSpaceState extends State<AdminAppointPubSpace> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Admin Appoint Public Space'),
      ),
...
class _DisplayAppointmentsState extends State<DisplayAppointments> {
  ...
  String dropdownvalue = 'Please choose a type of court';

  // List of items in our dropdown menu
  var items = [
    'Please choose a type of court',
    '- BasketBall Court',
    '- Badminton Court',
  ];
...
class DisplayAppointmentsPool extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance
          .collection('pubspace')
          .where('typefacility', isEqualTo: '- Badminton Court')
      //         .orderBy('checkintime', descending: false)
      //         .startAfter()
      //         .limit(10)
          .snapshots(),
