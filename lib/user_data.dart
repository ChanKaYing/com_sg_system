          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => EditProfilePage(_nameController.text, _emailController.text, _addressController.text)),
                );
              },
...
class EditProfilePage extends StatefulWidget {
  ...
  EditProfilePage(this.name, this.email, this.address);
